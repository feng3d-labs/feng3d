namespace feng3d
{
    ...
    QUnit.module("Serialization", () =>
    {
        QUnit.test("serialize&deserialize 函数", (assert) =>
        {
            ...
            var r0 = serialization.serialize(serialization.serializeHandlers);
            var serializeReplacers = serialization.deserialize(r0);
        ...
        QUnit.test("serialize&deserialize 循环引用以及多次引用", (assert) =>
        {
            ...
            var r = serialization.serialize(a);

            var r1 = serialization.deserialize(r);
            ...
            var rr = serialization.serialize(aa);

            var rr1 = serialization.deserialize(rr);
