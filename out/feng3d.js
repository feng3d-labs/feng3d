...
(function (feng3d) {
     ...
     */
    function getTimer() {
        return Date.now() - feng3d.engine.ticker.startTime;
    }
...
(function (feng3d) {
    ...
    var Serialization = (function () {
        ...
        Serialization.prototype.readObject = function (data) {
            ...
            feng3d.engine.debuger && console.assert(cls != null);
            var object = new cls();
...
(function (feng3d) {
    ...
    var KeyCapture = (function () {
        ...
        function KeyCapture(shortCut) {
            ...
            var input = feng3d.engine.input;
            var inputType = feng3d.engine.inputType;
            //
...
(function (feng3d) {
    ...
    var Matrix3D = (function () {
        ...
        Matrix3D.prototype.append = function (lhs) {
            ...
            feng3d.engine.debuger && feng3d.assert(this.rawData[0] !== NaN && this.rawData[4] !== NaN && this.rawData[8] !== NaN && this.rawData[12] !== NaN);
            return this;
        };
        /**
...
(function (feng3d) {
    ...
    function getWebGLProgram(gl, vertexCode, fragmentCode) {
        ...
        if (!linked) {
            ...
            feng3d.engine.debuger && console.error('Failed to link program: ' + error + ("\n" + vertexCode + "\n" + fragmentCode));
    ...
    function getVertexShader(gl, vertexCode) {
        ...
        if (shader == null) {
            feng3d.engine.debuger && console.error('unable to create shader');
            return null;
        }
    ...
    function compileShader(gl, shader, shaderCode) {
        ...
        if (!compiled) {
            ...
            feng3d.engine.debuger && console.error("\u7F16\u8BD1\u6E32\u67D3\u7A0B\u5E8F\u65F6\u53D1\u751F\u9519\u8BEF: " + error + " \n " + gl.getShaderInfoLog(shader) + "\n" + shaderCode);
...
(function (feng3d) {
    ...
    var Object3D = (function (_super) {
         ...
         * 更新渲染数据
         */
        Object3D.prototype.updateRenderData = function (renderContext, renderData) {
            //
        ...
        Object3D.prototype.addChildAt = function (child, index) {
            feng3d.engine.debuger && console.assert(index >= 0 && index <= this.children_.length);
        ...
        Object3D.prototype.removeChildAt = function (index) {
            feng3d.engine.debuger && console.assert(-1 < index && index < this.children_.length);
         ...
         * @param index			插入的位置
         */
        Object3D.prototype.addComponentAt = function (component, index) {
            feng3d.engine.debuger && console.assert(component instanceof feng3d.Object3DComponent, "只有Object3DComponent新增为Object3D组件！");
         ...
         * @param index		要删除的 Component 的子索引。
         */
        Object3D.prototype.removeComponentAt = function (index) {
            var component = _super.prototype.removeComponentAt.call(this, index);
            if (component instanceof feng3d.Transform) {
...
(function (feng3d) {
    ...
    var View3D = (function () {
        ...
        function View3D(canvas, scene, camera) {
            ...
            feng3d.engine.ticker.addEventListener(feng3d.Event.ENTER_FRAME, this.drawScene, this);
        }
        /**
         * 初始化GL
         */
    ...
    var Transform = (function (_super) {
        ...
        Object.defineProperty(Transform.prototype, "matrix3d", {
            ...
            set: function (value) {
                ...
                feng3d.engine.debuger && this._debug();
...
(function (feng3d) {
    ...
    var Model = (function (_super) {
        ...
        Model.prototype.collectRenderDataHolder = function (renderAtomic) {
            if (renderAtomic === void 0) { renderAtomic = null; }
            var material = this.material || feng3d.engine.defaultMaterial;
            var geometry = this.geometry || feng3d.engine.defaultGeometry;
...
(function (feng3d) {
    ...
    var Scene3D = (function (_super) {
        ...
        Object.defineProperty(Scene3D.prototype, "renderContext", {
            /**
             * 渲染环境
             */
            get: function () {
...
(function (feng3d) {
    ...
    var TextureInfo = (function (_super) {
        ...
        TextureInfo.prototype.checkRenderData = function () {
            feng3d.engine.debuger && console.assert(false);
            return false;
        };
        /**
         * 使纹理失效
    ...
    var FPSController = (function (_super) {
        ...
        FPSController.prototype.onMouseMove = function (event) {
            if (this.target == null)
                return;
            var input = feng3d.engine.input;
            var mousePoint = new feng3d.Point(input.clientX, input.clientY);
...
(function (feng3d) {
    ...
    var AnimatorBase = (function (_super) {
        ...
        AnimatorBase.prototype.start = function () {
            ...
            feng3d.engine.ticker.addEventListener(feng3d.Event.ENTER_FRAME, this.onEnterFrame, this);
        ...
        AnimatorBase.prototype.stop = function () {
            ...
            if (feng3d.engine.ticker.hasEventListener(feng3d.Event.ENTER_FRAME))
                feng3d.engine.ticker.removeEventListener(feng3d.Event.ENTER_FRAME, this.onEnterFrame, this);
...
(function (feng3d) {
    ...
    var Trident = (function (_super) {
        ...
        Trident.prototype.buildTrident = function (length) {
            ...
            //
            this._xArrow = new feng3d.Object3D();
...
(function (feng3d) {
    var Engine = (function () {
        ...
        Object.defineProperty(Engine.prototype, "serialization", {
            /**
             * 数据持久化
             */
            get: function () {
                return this._serialization = this._serialization || new feng3d.Serialization();
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Engine.prototype, "input", {
             ...
             */
            get: function () {
                return this._input = this._input || new feng3d.Input();
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Engine.prototype, "inputType", {
            get: function () {
                return this._inputType = this._inputType || new feng3d.InputEventType();
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Engine.prototype, "shortcut", {
            /**
             * 快捷键
             */
            get: function () {
                return this._shortcut = this._shortcut || new feng3d.ShortCut();
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Engine.prototype, "defaultMaterial", {
            /**
             * 默认材质
             */
            get: function () {
                return this._defaultMaterial = this._defaultMaterial || new feng3d.StandardMaterial();
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Engine.prototype, "defaultGeometry", {
            /**
             * 默认几何体
             */
            get: function () {
                return this._defaultGeometry = this._defaultGeometry || new feng3d.CubeGeometry();
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Engine.prototype, "ticker", {
             ...
             */
            get: function () {
                return this._systemTicker = this._systemTicker || new feng3d.SystemTicker();
            },
            enumerable: true,
            configurable: true
        });
