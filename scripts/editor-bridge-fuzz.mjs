...
const cases = [
    ...
    ['view.probe', { grid: 1e9, colors: 1e9 }],
    ['view.probe', { region: { x: 0, y: 0, width: 0, height: 0 } }],
    ['view.probe', { region: 'middle' }],
    ['view.probe', { project: '/Untitled/Plane' }],
    ['view.probe', { project: ['/Untitled/__nope__'] }],
    ['view.probe', { projectAll: 'yes' }],
    ['scene.get', {}],
    ['scene.get', { objectIds: [] }],
    ['scene.get', { objectId: '/Untitled/__nope__' }],
    ['scene.get', { objectId: '/Untitled/Plane', limit: 0 }],
    ['scene.find', { namePattern: '.', sortBy: 'scale.x' }],
    ['scene.find', { namePattern: '.', order: 'up' }],
    ['scene.find', { namePattern: '.', where: [{}, {}] }],
    ['scene.find', { namePattern: '.', limit: -1 }],
    ['scene.list', { depth: -1 }],
    ['scene.list', { depth: 1e9 }],
    ['scene.list', { path: '/Untitled/__nope__' }],
    ['scene.bounds', {}],
    ['scene.bounds', { objectIds: [] }],
    ['editor.overview', { issues: -5 }],
    ['editor.overview', { issues: 1e9 }],
    ['log.tail', { type: 'verbose' }],
    ['camera.focus', { objectId: '/Untitled/__nope__' }],
    ['camera.setView', { preset: 'diagonal', objectId: '/Untitled/Plane' }],
    ['selection.set', { objectIds: ['/Untitled/__nope__'] }],
