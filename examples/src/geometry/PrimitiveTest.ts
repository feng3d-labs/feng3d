import { Camera, Color4, ColorMaterial, CubeGeometry, CustomGeometry, Object3D, Matrix4x4, PlaneGeometry, reactive, Renderable, Scene, SphereGeometry, Vector3, View, object3DLogic, cameraLogic, sceneLogic, createObject3D} from 'feng3d';
...
const model = new Renderable(); reactive(object3D).components.push(model);
