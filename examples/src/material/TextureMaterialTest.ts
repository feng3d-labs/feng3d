import { Camera, Color4, CubeGeometry, Object3D, reactive, Renderable, Scene, StandardMaterial, View, object3DLogic, cameraLogic, sceneLogic, createObject3D} from 'feng3d';
