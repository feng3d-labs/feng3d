import { Camera, Color4, GameObject, PointGeometry, PointMaterial, reactive, Renderable, Scene, Vector3, View } from 'feng3d';
...
const gameObject = new GameObject(); gameObject.name = "plane";
