import { batchRun, Camera, Color4, FPSController, Object3D, reactive, Renderable, Scene, SkyBox, TextureCube, transformLogic, Transform, Vector3, View, object3DLogic } from 'feng3d';
