import { Object3D, batchRun, Camera, Color4, FPSController, reactive, Renderable, Scene, SkyBox, TextureCube, transformLogic, Vector3, View, object3DLogic, cameraLogic, sceneLogic} from 'feng3d';
...
const model = new SkyBox(); reactive(skybox).components.push(model);
