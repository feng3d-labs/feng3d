...
const holdSizeComponent = new HoldSizeComponent(); reactive(object3D).components.push(holdSizeComponent); holdSizeComponent.setObject3D(object3D); holdSizeComponent.init();
holdSizeComponent.holdSize = 1;
holdSizeComponent.camera = camera;
const billboardComponent = new BillboardComponent(); reactive(object3D).components.push(billboardComponent); billboardComponent.setObject3D(object3D); billboardComponent.init();
