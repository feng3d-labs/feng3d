import { Camera, Color3, Color4, CubeGeometry, decoratorRegisterClass, FogMode, Object3D, reactive, Renderable, Scene, Script, ScriptComponent, StandardMaterial, Texture2D, View, logic, cameraLogic, sceneLogic, createObject3D} from 'feng3d';
