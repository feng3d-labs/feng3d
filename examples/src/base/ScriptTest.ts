import { Camera, Color3, Color4, CubeGeometry, decoratorRegisterClass, FogMode, Object3D, reactive, Renderable, Scene, Script, StandardMaterial, Texture2D, View, object3DLogic } from 'feng3d';
...
const sc = object3DLogic(scene.object3D).addScript('ScriptDemo');
