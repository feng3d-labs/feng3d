import { Camera, Color3, Color4, CubeGeometry, decoratorRegisterClass, FogMode, Object3D, reactive, Renderable, Scene, Script, ScriptComponent, StandardMaterial, Texture2D, View, object3DLogic } from 'feng3d';
...
const sc = new ScriptComponent(); sc.scriptName = 'ScriptDemo'; reactive(scene.object3D).components.push(sc); sc.setObject3D(scene.object3D); sc.init();
