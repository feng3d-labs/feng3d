import { Object3D, batchRun, Camera, Color3, Color4, FPSController, PointLight, reactive, Renderable, Scene, StandardMaterial, TerrainGeometry, Texture2D, ticker, transformLogic, Vector3, View, object3DLogic } from 'feng3d';
