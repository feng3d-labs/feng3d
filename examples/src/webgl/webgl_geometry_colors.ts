...
{
    const positions = ico.vertices.a_position.data as unknown as number[];
    const indices = (ico as unknown as { vertexIndices: number[] }).vertexIndices;
...
const wireframe1: SegmentGeometry = { __type__: 'SegmentGeometry', segments: buildWireframeSegments(ico1.vertices.a_position.data as unknown as number[], (ico1 as unknown as { vertexIndices: number[] }).vertexIndices) };
const wireframe2: SegmentGeometry = { __type__: 'SegmentGeometry', segments: buildWireframeSegments(ico2.vertices.a_position.data as unknown as number[], (ico2 as unknown as { vertexIndices: number[] }).vertexIndices) };
const wireframe3: SegmentGeometry = { __type__: 'SegmentGeometry', segments: buildWireframeSegments(ico3.vertices.a_position.data as unknown as number[], (ico3 as unknown as { vertexIndices: number[] }).vertexIndices) };
