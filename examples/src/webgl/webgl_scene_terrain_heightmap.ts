...
const geo: CustomGeometry = { __type__: 'CustomGeometry' }; const gl = logic(geo); gl.positions = pos; gl.normals = nor; gl.uvs = uv; gl.colors = col; (gl as unknown as { indices: number[] }).indices = idx;
