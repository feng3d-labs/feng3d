...
const v: View = {
    ...
    root: {
        ...
        children: [
            { __type__: 'Object3D', name: 'cam', position: { x: 0, y: 0, z: 12 }, rotation: gr = { x: 0, y: 0, z: 0 },
              components: [{ __type__: 'PerspectiveCamera', fov: 50, aspect: wc.width / wc.height, near: 0.1, far: 100 }, { __type__: 'OrbitControls', target: { x: 0, y: 0, z: 0 }, autoRotate: true, autoRotateSpeed: 0.5 }] },
            ...
            ...refl.map((r, i) => ({ __type__: 'Object3D', name: 's' + i, position: { x: (i - 1.5) * 3, y: 0, z: 0 }, rotation: { x: 0, y: 0, z: 0 }, components: [{ __type__: 'MeshRenderer', geometry: { __type__: 'SphereGeometry', radius: 1.2, segmentsW: 64, segmentsH: 32 }, material: { __type__: 'StandardMaterial', uniforms: { u_diffuse: { __type__: 'Color4', r: 0.2, g: 0.2, b: 0.2, a: 1 }, u_specular: { __type__: 'Color4', r: 0.8, g: 0.8, b: 0.8, a: 1 }, u_glossiness: 100, u_reflectivity: r }, s_envMap: env as unknown as StandardMaterial['s_envMap'] } }] }) as Object3D),
