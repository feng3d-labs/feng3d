namespace feng3d
{
    ...
    export class TextureCube extends TextureInfo
    {
        ...
        private _loadItemTexture(texture: Texture2D, index: number)
        {
            ...
            texture.onLoadCompleted(() =>
            {
                ...
                arrayutils.delete(this._loading, texture);
        ...
        private _loadItemImagePath(imagepath: string, index: number)
        {
            ...
            fs.readImage(imagepath, (err, img) =>
            {
                ...
                arrayutils.delete(this._loading, imagepath);
                this._onItemLoadCompleted();
            });
        }
    ...
    rs.setDefaultAssetData(TextureCube.default = serialization.setValue(new TextureCube(), { name: "Default-TextureCube", assetId: "Default-TextureCube", hideFlags: HideFlags.NotEditable }));
}