...
export type { Event } from './event/EventEmitter';
export { event, FEvent } from './event/FEvent';
// export {View} from './core/View';
export { globalEmitter as globalDispatcher } from './event/GlobalEmitter';
export type { GlobalEvents } from './event/GlobalEmitter';
export { objectevent } from './event/ObjectEvent';
export type { ObjectEventType } from './event/ObjectEvent';
