...
const light0 = feng3d.serialization.setValue(new feng3d.GameObject(), { name: "pointLight" });
const light1 = feng3d.serialization.setValue(new feng3d.GameObject(), { name: "pointLight" });
...
function initObjects() {
    ...
    cubemodel.geometry = feng3d.serialization.setValue(new feng3d.CubeGeometry(), { width: 1, height: 1, depth: 1, segmentsW: 1, segmentsH: 1, segmentsD: 1, tile6: false });
