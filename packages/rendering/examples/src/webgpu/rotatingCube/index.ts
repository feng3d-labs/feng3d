...
import { BufferBinding, RenderObject, RenderPassDescriptor, Submit, WebGPU } from '@feng3d/webgpu';
...
import {
    ...
    cubeVertexCount,
    cubeVertexSize,
} from '@feng3d/rendering';
import { basicVertWGSL } from '@feng3d/rendering';
import { vertexPositionColorFragWGSL } from '@feng3d/rendering';
...
const init = async (canvas: HTMLCanvasElement) =>
{
    ...
    const renderObject: RenderObject = {
        pipeline: {
            vertex: { code: basicVertWGSL }, fragment: { code: vertexPositionColorFragWGSL },
            primitive: {
                cullFace: 'back',
            },
        },
