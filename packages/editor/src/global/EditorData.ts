...
export class EditorData
{
     ...
     */
    get selectedObjects(): Array<Object3D | AssetNode> {
        return this.store.selectedObjects as Array<Object3D | AssetNode>;
    }

    set selectedObjects(v: Array<Object3D | AssetNode>) {
     ...
     * @param objs 选中的对象
     */
    selectMultiObject(objs: (Object3D | AssetNode)[], isAdd?: boolean)
    {
     ...
     * 选中游戏对象列表
     */
    get selectedObject3Ds(): Object3D[] {
        return this.store.selectedObject3Ds as Object3D[];
    }
     ...
     * 变换对象
     */
    get transformObject3D(): Object3D | null {
        return this.store.transformObject3D as Object3D | null;
    }
