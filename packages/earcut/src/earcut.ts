 ...
 */
export function earcut(vertices: ArrayLike<number>, holes?: ArrayLike<number>, dimensions?: number)
{
...
export function deviation(vertices: ArrayLike<number>, holes: ArrayLike<number>, dimensions: number, triangles: ArrayLike<number>)
{
    const hasHoles = holes && holes.length;
    const outerLen = hasHoles ? holes[0] * dimensions : vertices.length;
