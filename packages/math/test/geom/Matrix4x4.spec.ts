...
describe('Matrix4x4', () =>
{
    it('invert', () =>
    {
        const mat = new Matrix4x4().fromTRS(Vector3.random(), Vector3.random(), Vector3.random());
    ...
    {
        const vs = [Vector3.random(), Vector3.random(), Vector3.random()];
        vs[2].set(1, 1, 1);
        ...
        const t = Matrix4x4.fromPosition(vs[0].x, vs[0].y, vs[0].z);
        const r = Matrix4x4.fromRotation(vs[1].x, vs[1].y, vs[1].z);
        const s = Matrix4x4.fromScale(vs[2].x, vs[2].y, vs[2].z);
    ...
    it('！！！！', () =>
    {
        const mat0 = new Matrix4x4().fromTRS(Vector3.random(), Vector3.random(360), Vector3.random());
        const mat1 = new Matrix4x4().fromTRS(Vector3.random(), Vector3.random(360), Vector3.random());
    ...
    it('fromRotation', () =>
    {
        const r = Vector3.random(360, true);

        //
        let mat = Matrix4x4.fromRotation(r.x, r.y, r.z, RotationOrder.ZYX);
        ...
        //
        mat = Matrix4x4.fromRotation(r.x, r.y, r.z, RotationOrder.YZX);
        mat0 = new Matrix4x4()
            .appendRotation(Vector3.X_AXIS, r.x)
            .appendRotation(Vector3.Z_AXIS, r.z)
            .appendRotation(Vector3.Y_AXIS, r.y)
        ...
        //
        mat = Matrix4x4.fromRotation(r.x, r.y, r.z, RotationOrder.ZXY);
        mat0 = new Matrix4x4()
            .appendRotation(Vector3.Y_AXIS, r.y)
            .appendRotation(Vector3.X_AXIS, r.x)
            .appendRotation(Vector3.Z_AXIS, r.z)
        ...
        mat = Matrix4x4.fromRotation(r.x, r.y, r.z, RotationOrder.XZY);
        mat0 = new Matrix4x4()
            .appendRotation(Vector3.Y_AXIS, r.y)
            .appendRotation(Vector3.Z_AXIS, r.z)
            .appendRotation(Vector3.X_AXIS, r.x)
        ...
        //
        mat = Matrix4x4.fromRotation(r.x, r.y, r.z, RotationOrder.YXZ);
        mat0 = new Matrix4x4()
            .appendRotation(Vector3.Z_AXIS, r.z)
            .appendRotation(Vector3.X_AXIS, r.x)
            .appendRotation(Vector3.Y_AXIS, r.y)
        ...
        //
        mat = Matrix4x4.fromRotation(r.x, r.y, r.z, RotationOrder.XYZ);
        mat0 = new Matrix4x4()
            .appendRotation(Vector3.Z_AXIS, r.z)
            .appendRotation(Vector3.Y_AXIS, r.y)
            .appendRotation(Vector3.X_AXIS, r.x)
