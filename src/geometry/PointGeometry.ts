namespace feng3d
{
    ...
    rs.setDefaultAssetData(Geometry.point = Object.setValue(new PointGeometry(), { name: "PointGeometry", assetId: "PointGeometry", points: [], hideFlags: HideFlags.NotEditable }));
}