namespace feng3d
{
    ...
    rs.setDefaultAssetData(Geometry.point = Object.setValue(new PointGeometry(), { name: "PointGeometry", assetsId: "PointGeometry", points: [], hideFlags: HideFlags.NotEditable }));
}