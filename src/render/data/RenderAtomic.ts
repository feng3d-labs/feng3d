namespace feng3d
{
    ...
    export class RenderAtomic
    {
        ...
        addUniform(uniformData: UniformData)
        {
            this.uniforms[uniformData.name] = uniformData;
        }

        removeUniform(uniformData: UniformData)
        {
            delete this.uniforms[uniformData.name];
        }

        addAttribute(attributeData: AttributeRenderData)
        {
            this.attributes[attributeData.name] = attributeData;
        }

        removeAttribute(attributeData: AttributeRenderData)
        {
         ...
         * 渲染实例数量
         */
        private instanceCount: number | (() => number);
         ...
         * 激活属性
         */
        activeAttributes(gl: GL, attributeInfos: WebGLActiveInfo[])
        {
         ...
         * 激活常量
         */
        activeUniforms(gl: GL, uniformInfos: WebGLActiveInfo[])
        {
