namespace feng3d
{
    ...
    export interface RenderElement extends IEvent<RenderElementEventMap>
    {
        ...
        on<K extends keyof RenderElementEventMap>(type: K, listener: (event: RenderElementEventMap[K]) => any, thisObject?: any, priority?: number, once?: boolean);
        off<K extends keyof RenderElementEventMap>(type?: K, listener?: (event: RenderElementEventMap[K]) => any, thisObject?: any);
    }
