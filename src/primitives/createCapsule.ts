module feng3d.primitives {
     ...
     */
    export function createCapsule(radius = 50, height = 100, segmentsW = 16, segmentsH = 15, yUp = true, elements = [GLAttribute.a_position, GLAttribute.a_uv, GLAttribute.a_normal, GLAttribute.a_tangent]): Geometry {
