namespace feng3d
{
    ...
    export class MD5Loader
    {
        ...
        private createMD5Mesh(md5MeshData: MD5MeshData, completed?: (gameObject: GameObject) => void)
        {
        ...
        private createAnimator(md5AnimData: MD5AnimData, completed?: (animationClip: AnimationClip) => void)
        {
