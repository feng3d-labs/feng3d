namespace feng3d
{
    ...
    AssetData.addAssetData("Default-TextureCube", TextureCube.default = serialization.setValue(new TextureCube(), { name: "Default-TextureCube", assetId: "Default-TextureCube", hideFlags: HideFlags.NotEditable }));
}