module feng3d
{
    ...
    export class Transform extends Object3DComponent
    {
        ...
        public set sx(value: number) { this._sx = value || 1; this.invalidateMatrix3D(); }

        /**
         * Y缩放
         */
        public get sy(): number { return this._sy; }
        public set sy(value: number) { this._sy = value || 1; this.invalidateMatrix3D(); }

        /**
         * Z缩放
         */
        public get sz(): number { return this._sz; }
        public set sz(value: number) { this._sz = value || 1; this.invalidateMatrix3D(); }
        ...
        public set scale(value: Vector3D) { this._sx = value.x || 1; this._sy = value.y || 1; this._sz = value.z || 1; this.invalidateMatrix3D(); }
