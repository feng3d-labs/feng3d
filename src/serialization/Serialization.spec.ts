...
@Serializable('ObjectBase' as any)
class ObjectBase
{
    @SerializeProperty()
    id = 1;
...
describe('Serialization', () =>
{
    ...
    it('$diff 循环引用以及多次引用', () =>
    {
        ...
        //assert.deepEqual($diff(o, $clone(o)), {});
        assert.ok(true);
    });
    ...
    //         const r = $serialize(obj);
    //        assert.deepEqual(r, <any>{ __class__: 'Feng3dObject' }); // 忽略默认值 hideFlags: HideFlags.None
    //     }
    ...
    it('serialize&deserialize 自定义对象', () =>
    {
        ...
        //assert.deepEqual(r2, { __class__: 'Vector2' });

        // {
        //     o2.x = 1;
        //     const r2 = $serialize(o2);
        //    assert.deepEqual(r2, { __class__: 'Vector2', x: 1 });
        // }

        // //
        // const obj = new Entity().addComponent(Node3D);
        // const diff2 = $serialize(obj);
        //assert.deepEqual(diff2, { __class__: 'Node3D' });
        ...
        //assert.deepEqual(r3, { __class__: 'Node3D' });
        ...
        //assert.equal(entity.numComponents, 2);
    ...
    //    assert.deepEqual(diff1, { v: { __class__: 'Vector2' } });
    ...
    it('Float32Array 序列化反序列化', () =>
    {
        ...
        assert.deepEqual(result1.arr, arr);
        assert.equal(result1.arr, result1.arr1);
    });
