namespace feng3d
{
    ...
    export class FunctionWrap
    {
         ...
         */
        extendFunction<T, K extends feng3d.ExtractFunctionKeys<T>, V extends T[K]>(object: T, funcName: K, extendFunc: (this: T, r: ReturnType<V>, ...ps: Parameters<V>) => ReturnType<V>)
        {
