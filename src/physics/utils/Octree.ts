namespace CANNON
{
    export class OctreeNode
    {
        ...
        subdivide()
        {
            ...
            children.push(
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(0, 0, 0) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(1, 0, 0) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(1, 1, 0) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(1, 1, 1) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(0, 1, 1) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(0, 0, 1) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(1, 0, 1) }) }),
                new OctreeNode({ aabb: new AABB({ lowerBound: new Vector3(0, 1, 0) }) })
            );
