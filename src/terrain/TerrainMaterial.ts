namespace feng3d
{
    ...
    Feng3dAssets.setAssets(Material.terrain = new Material().value({ name: "Terrain-Material", assetsId: "Terrain-Material", shaderName: "terrain", hideFlags: HideFlags.NotEditable }));
}