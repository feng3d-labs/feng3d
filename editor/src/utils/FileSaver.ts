...
// @see https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/file-saver/index.d.ts
 ...
 */
declare function FileSaver(data: Blob | string, filename?: string, options?: FileSaverOptions): void;
...
export const saveAs: typeof FileSaver = saveAs1;
